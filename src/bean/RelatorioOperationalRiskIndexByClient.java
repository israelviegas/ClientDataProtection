...
public class RelatorioOperationalRiskIndexByClient {
	...
	public void setCDPTrackerID(String cDPTrackerID) {
		CDPTrackerID = cDPTrackerID;
	}
	...
	public String getMasterCustomerNbr() {
		return MasterCustomerNbr;
	}

	public void setMasterCustomerNbr(String masterCustomerNbr) {
		MasterCustomerNbr = masterCustomerNbr;
	}
	...
	public String getAccountableMD() {
		return AccountableMD;
	}

	public void setAccountableMD(String accountableMD) {
		AccountableMD = accountableMD;
	}

	public String getAccountISL() {
		return AccountISL;
	}

	public void setAccountISL(String accountISL) {
		AccountISL = accountISL;
	}

	public String getAccountContractManager() {
		return AccountContractManager;
	}

	public void setAccountContractManager(String accountContractManager) {
